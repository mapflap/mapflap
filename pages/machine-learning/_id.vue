...
export default {
    ...
    head() {
        return {
            title: ` ${this.work.short} | Machine Learning`,
            meta: [
                {
                    hid: 'descriptionSingleML',
                    name: 'description',
                    content: 'specific ML work and its related info: Name, description, image, technologies and related link',
                },
                {
                    hid: 'keywordsSingleML',
                    name: 'keywords',
                    content: ["Machine Learning", "Data analysis", "Mapflap", this.work.short, this.work.technologies],
                },
            ],
        }
    },
